...
public sealed class CreateProfileRequestTests
{
    [Fact]
    ...
    public void Unsupported_image_types_fail_validation(string mime, string base64)
    {
        var request = CreateValidRequest(profileBase64: $"data:{mime};base64,{base64}");
    ...
    private static List<ValidationResult> Validate(CreateProfileRequest request)
    {
