...
# SV-PF-02 — OWASP Security Baseline
...
| Browser security             | ทำแล้วสำหรับ local    | CSP, MIME sniffing, frame, referrer และ permissions headers ผ่าน; CSP อนุญาตเฉพาะ hash ของ Angular stylesheet loader | production ต้องใช้ HTTPS และทบทวน CSP ตามชิ้นงาน build จริง                                        |
...
10. รันและผ่าน `QAT-PF-08` ก่อนอนุมัติ production
