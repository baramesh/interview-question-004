...
| Playwright Chromium           | ผ่าน 18 รายการ รวม production copy, Success/Error Toast, ID, Angular Material Datepicker, avatar และ security 6 รายการ; มี screenshot ครบใน `playwright-test-result.md` |
| Angular production build      | ผ่าน ขนาดเริ่มต้น 826.28 kB รวม Google Sans, Material Icons, Angular Material Datepicker, MatSnackBar และ date-fns ในระบบ                                               |
...
| Production copy               | ไม่แสดงรหัสข้อสอบ ป้ายภายใน ข้อมูลบุคคลทดสอบ ข้อความทวนชื่อหมวด หรือ `PF`; ใช้ไอคอนโปรไฟล์จาก Material Icons                                                            |
